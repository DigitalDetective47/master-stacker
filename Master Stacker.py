        ...
        if mode in{1,2,3,4,6}:
                ...
                if testPieceCollision():
                    ...
                    if lockTime==0:
                        ...
                        if linesCleared==0:
                            ...
                            combo+=1
                            score+=int(lineClearValues[0][linesCleared]*(0.95+0.05*combo))
            ...
            if toppedOut:
                if mode!=5:
                    ...
                    if missionNumber==missionsUnlocked and gameWin:
                        missionsUnlocked+=1
                        updateSettings()
            ...
            if time==-1:
                ...
                fallTime=[57.6650390625,]*vsPlayerCount
                    ...
                    if gamePaused:
                        ...
                        if testPieceCollision(currentPlayerHandle):
                            ...
                            if lockTime[currentPlayerHandle]==0:
                                ...
                                pieceY[currentPlayerHandle]=17
                                pieceR[currentPlayerHandle]=0
                                fallTime[currentPlayerHandle]=57.6650390625
                                lockTime[currentPlayerHandle]=60
                                pieceLowestY[currentPlayerHandle]=17
            ...
            if pausePressed:
                ...
                pauseMem=False
            if menuPage in{1,2}:
                formattedLeaderboardScoreData=[]#[Name,Score,Settings Match]
                for i in leaderboards:
                    if i[0]==menuPage and i[4]==0:
                ...
                formattedLeaderboardTimeData=[]#[Name,Time,Settings Match]
                for i in leaderboards:
                ...
                for i in range(5*leaderboardScrollPosition,5*leaderboardScrollPosition+5):
                    if len(formattedLeaderboardTimeData)>i:
                        drawText(formattedLeaderboardTimeData[i][0]+(" "if formattedLeaderboardScoreData[i][2]else "!")+("{:02}'{:02}\"{:02}".format(formattedLeaderboardTimeData[i][1]//3600,formattedLeaderboardTimeData[i][1]//60%60,formattedLeaderboardTimeData[i][1]%60)if formattedLeaderboardTimeData[i][1]<359999 else"99'59\"59"),(224,128+8*(i-5*leaderboardScrollPosition)))
                    else:
                        break
                ...
                formattedLeaderboardScoreData.sort(reverse=True,key=lambda x:x[1])
                formattedLeaderboardLinesData=[]#[Name,Lines,Settings Match]
                for i in leaderboards:
